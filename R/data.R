...
#'
#' This dataset contains the original arrival data of 40 mice. #' In addition it contains optimal treatment assignments and 
#' optimal assignments into cages generated by Guido.
#' The `Group` variable is the assigned treatment group, and 
#' `CageNr`, `CageCol`, and `CageRow` variables are the assigned cage and its position.
