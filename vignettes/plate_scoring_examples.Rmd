...
This should reliably lead to a nice latin square design.
...
This confounding also causes initial scores to start from Inf(inity). 
...
# Add samples to container
assign_in_order(example2, samples = tibble::tibble(Group = rep(c("Grp 1", "Grp 2", "Grp 3", "Grp 4"), each = 8), 
                                                   Pos = 1:32))
