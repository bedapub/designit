...
In some cases it may be essential to avoid samples of the same group being put into the same row or column
on a plate, i.e. these variables are regarded as factor levels of their own, in addition to the spatial relation
of the samples.

Plate scoring functions can use an specific penalty for these 'linearly arranged' samples on top of the
