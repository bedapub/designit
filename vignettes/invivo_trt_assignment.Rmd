...
shuffle_proposal2 <- mk_subgroup_shuffle_function(subg, possible, report_grouping_as_attribute = TRUE)
...
bc3$scoring_f <- list(
  function(samples) {
    osat_score(samples, batch_vars = "Treatment", feature_vars = c("Genotype", "Sex"))$score
  },
  function(samples) {
    osat_score(samples, batch_vars = "Treatment", feature_vars = c("Bodyweight"))$score
  }
)
...
bc6$scoring_f <- list(
  ...
  function(samples) {
    osat_score(samples, batch_vars = "Cage", feature_vars = c("Bodyweight"))$score
  }
)
