...
```{r}
n_shuffle <- rep(c(32, 10, 2), c(100, 100, 100)) 
...
bc2$samples_df <- multi_trt_day_samples
assign_in_order(bc2)
bc2$scoring_f <- function(samples) osat_score(samples, c("batch"), c("Treatment", "Time"))$score
