...
plot_plate(bc, plate = plate, column = column, row = row,
...
```{r, fig.width=6, fig.height=3.5}
bc$move_samples(
  location_assignment = as.integer(c(1:nrow(samples), 
                                     rep(NA, (bc$n_available - nrow(samples))))))
...
```{r, fig.width=6, fig.height=3.5}
color_palette <- c(TRT1 = "blue", TRT2 = "purple", 
