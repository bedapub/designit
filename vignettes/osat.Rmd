...
library(designit)
library(tidyverse)
osat_score_tibble <- designit:::osat_score_tibble
...
OSAT::getLayout(gc) %>%
  ...
  osat_score_tibble(plates, c(SampleType, Race, AgeGrp)) %>%
  .$score
...
```{r}
bc$scoring_f <- function(samples) osat_score_tibble(samples, plates, c(SampleType, Race, AgeGrp))$score
...
edf <- osat_score_tibble(bc$get_samples(), plates, c(SampleType, Race, AgeGrp))$expected_df

bc$scoring_f <- function(samples) osat_score_tibble(samples, plates, c(SampleType, Race, AgeGrp), expected_df = edf)$score
...
# precompute expected_df
edf <- osat_score(bc$samples_dt, "plates", c("SampleType", "Race", "AgeGrp"))$expected_df
