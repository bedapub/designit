...
bc$scoring_f <- function(samples) osat_score(samples, plates, c(SampleType, Race, AgeGrp), expected_df = edf)$score
...
bc$scoring_f <- function(samples) osat_score_datatable(data.table::data.table(samples), "plates", c("SampleType", "Race", "AgeGrp"), expected_df = edf)$score
